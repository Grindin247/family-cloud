...
def reset_db(monkeypatch):
    ...
    monkeypatch.setattr("app.routers.roadmap._emit_roadmap_event", lambda *args, **kwargs: None)
    monkeypatch.setattr("app.routers.budgets._emit_budget_event", lambda *args, **kwargs: None)
    monkeypatch.setattr("app.routers.families._emit_family_event", lambda *args, **kwargs: None)
    monkeypatch.setattr("app.routers.identity._emit_family_feature_event", lambda *args, **kwargs: None)
    ...
    monkeypatch.setattr("app.services.family_dna.publish_family_event", lambda *args, **kwargs: None)
